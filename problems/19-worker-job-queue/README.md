...
Implement a simple in-memory job queue with enqueue, dequeue, and acknowledgment.

## Signature

```ts
class JobQueue { enqueue(job: Job): void; dequeue(): Job | undefined; acknowledge(jobId: string): void }
```
