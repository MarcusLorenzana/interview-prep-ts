...
1. Read the README in the folder.
2. Clarify inputs, edge cases, and constraints with the interviewer.
3. Explain your approach before coding.
4. Implement the fix in starter.ts.
5. Run the sample tests or iterate with follow-up questions.

## Folder structure

Each folder includes:

- README.md: prompt, examples, constraints, and discussion points
- starter.ts: minimal TypeScript skeleton
- sample.test.ts: sanity-check tests for the expected behavior
